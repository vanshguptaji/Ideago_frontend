...
const Collage = ({ images }) => {
  ...
  return (
    <div className="relative flex w-full max-w-[900px] h-[420px] mx-auto items-center mt-20">
      {/* Text Section */}
      ...
      {/* Collage Section */}
      <div className="flex-shrink-0 relative w-[420px] h-[420px]">
        <DraggableCardContainer
          className="
            relative
            w-[420px] h-[420px]
        ...
        >
          ...
          {/* Bottom left image */}
          <DraggableCardBody className="absolute left-0 top-[140px] z-20 w-[200px] h-[180px] shadow-xl pointer-events-auto">
            <img
              src={images[1].src}
              alt={images[1].title}
              className="w-full h-full object-cover rounded"
          ...
          {/* Bottom right image */}
          <DraggableCardBody className="absolute right-0 top-[200px] z-30 w-[260px] h-[180px] shadow-2xl pointer-events-auto">
            <img
              src={images[2].src}
              alt={images[2].title}
              className="w-full h-full object-cover rounded"
