  ...
  <section className="relative w-full h-[480px] md:h-[720px] flex items-start justify-center overflow-hidden p-8 mt-20">
    ...
    <div className="relative z-10 max-w-5xl px-0 text-start flex flex-col items-start justify-center h-full">
      ...
      <p className="text-white text-base md:text-lg font-light font-marcellus text-start leading-relaxed">
        Ideago Interiors operates primarily in the fields of interior designing with a talented team of designers. We have successfully conceptualized and completed the interior designs of numerous residential, commercial projects as well as architectural projects. Our working nature is customer-friendly since , We're providing -
      </p>
    </div>
  </section>
);
